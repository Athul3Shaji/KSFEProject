    ...
    <>
      ...
      <div className="min-h-[calc(100vh-90px)] bg-white flex flex-col items-center pt-10">
        <div className="w-3/5 flex justify-between items-center mb-4">
          <h1 className="text-4xl font-bold mb-10 text-blue-800">Chitties</h1>
          <div className="relative">
            ...
            <input
              type="text"
              id="chitty-search"
              className="block w-80 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-600 focus:border-blue-600 p-2.5"
              placeholder="Search for chitties"
              value={searchTerm}
        ...
        <div className="w-3/5 mb-4 flex justify-end">
          <button
            className="bg-[#066769] text-gray-100 px-4 py-2 flex rounded-md hover:bg-[#055160]"
              ...
              <div className="relative bg-white rounded-lg shadow">
                ...
                <form className="p-4 md:p-5" onSubmit={handleAddChitty}>
                  ...
                  <div className="flex justify-center">
                    <button
                      type="submit"
                      className="bg-[#066769] text-gray-100 px-4 py-2 rounded-md hover:bg-[#055160]"
                    >
